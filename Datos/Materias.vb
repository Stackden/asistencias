...
Public Class Materias
    ...
    Public Sub Modificar(ByVal mat As Materias)
        Abrir()
        Dim strComando As String = "UPDATE Materias SET Nombre=@nombre, id=@id, CantidadHoras=@cantidadhoras, idProfesor=@idprofesor, IdCarrera=@idcarrera " + "WHERE id=@id;"
        Dim comando As New OleDbCommand(strComando, conexion)
        comando.Parameters.AddWithValue("@nombre", mat.nombre)
        comando.Parameters.AddWithValue("@id", mat.id)
        comando.Parameters.AddWithValue("@cantidadhoras", mat.CantHoras)
    ...
    Public Sub Agregar(ByVal mat As Materias)
        Abrir()
        Dim strComando As String = "INSERT INTO Materias (Nombre,CantidadHoras,idProfesor,IdCarrera,id) VALUES " & _
        "(@nombre,@cantidadhoras,@idprofesor,@idcarrera,@id);"
        Dim comando As New OleDbCommand(strComando, conexion)
        comando.Parameters.AddWithValue("@nombre", mat.nombre)
        comando.Parameters.AddWithValue("@cantidadhoras", mat.CantHoras)
        comando.Parameters.AddWithValue("@idprofesor", mat.idProfe)
